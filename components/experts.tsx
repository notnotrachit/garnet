    ...
    return (
      <div className="min-h-screen w-full bg-black/90 relative">
        <div className="w-full h-full inset-0 absolute bg-black/90 overflow-x-hidden">
          <div className="absolute top-28 left-28 rounded-full h-2/3 aspect-square bg-[#7BD5FB]/80  blur-3xl transition-all ease-in-out duration-1000" id="gblob1"></div>
          <div className="absolute bottom-28 left-[32rem] rounded-full h-96 aspect-square bg-[#5000BB] blur-3xl transition-all ease-in-out duration-1000" id="gblob2"></div>
          <div className="absolute top-28 right-28 rounded-full h-[32rem] aspect-square bg-[#5000BB] blur-3xl transition-all ease-in-out duration-1000" id="gblob3"></div>
          <div className="absolute bottom-28 right-[26rem] rounded-full h-[20rem] aspect-square bg-[#7BD5FB] blur-3xl transition-all ease-in-out duration-1000" id="gblob4"></div>
